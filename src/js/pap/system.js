const login = {
  containerId: "container-system-login",
  ...
  listItems: [
    {
      ...
      descriptions: [
        "Essa requisição é responsável por buscar e retornar os menus e os submenus que estarão disponíveis para o usuário acessar, eles são condicionados de acordo com o acesso que o usuário possui, tendo essa verificação feita exclusivamente no backend;",
